...
export default function Sidebar() {
  ...
  return (
    <aside className="shrink-0 shadow-[4px_0_24px_-8px_oklch(0.646_0.222_41.116/0.4)] bg-zinc-900 border-r border-orange-500/30 flex p-6 flex-col w-60 h-screen sticky top-0 overflow-hidden relative">
      {/* Logo */}
      <div className="flex mb-8 px-1 items-center">
